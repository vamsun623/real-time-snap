const CARD_DATA = [
    { name: '美國隊長', cost: 3, power: 3, type: 'ongoing', effect: 'buff_others', desc: '在此區域的其他卡牌 +1 戰力。', img: 'assets/card_cap.png' },
    { name: '鋼鐵人', cost: 5, power: 0, type: 'ongoing', effect: 'double_total', desc: '此區域的總戰力翻倍。', img: 'assets/card_ironman.png' },
    { name: '浩克', cost: 6, power: 12, type: 'none', desc: '無特殊能力，但戰力驚人。', img: 'assets/card_hulk.png' },
    { name: '蟻人', cost: 1, power: 1, type: 'ongoing', effect: 'antman', desc: '若此區域已滿，戰力 +3。', img: 'assets/card_antman.png' },
    { name: '索爾', cost: 3, power: 4, type: 'on_reveal', action: 'thor_reveal', desc: '揭示：使此區域所有其他我方卡牌 +2 戰力。', img: 'assets/card_thor.png' },
    { name: '藍驚奇', cost: 5, power: 3, type: 'ongoing', effect: 'buff_others_global', desc: '全場所有其他我方卡牌 +1 戰力。', img: 'assets/card_blue_marvel.png' },
    { name: 'X教授', cost: 5, power: 3, type: 'ongoing', effect: 'lock_zone', desc: '持續：鎖定此區域，雙方都不能再放置卡牌。', img: 'assets/card_profx.png' },
    { name: '鋼鐵心', cost: 3, power: 0, type: 'on_reveal', action: 'buff_others_random', desc: '揭示：為場上其他隨機 3 張我方卡牌 +2 戰力。', img: 'assets/card_ironheart.png' },
    ...
    { name: '葛摩菈', cost: 5, power: 7, type: 'on_reveal', action: 'check_enemy', bonus: 6, desc: '揭示：若此區域已有對手卡牌，戰力 +6。', img: 'assets/card_gamora.png' },
